"""
Модуль содержит функции для работы с сообщениями, профилем пользователя, контактами, группами,
уведомлениями и избранными сообщениями. Использует SQLAlchemy ORM.
"""
...
async def create_private_message(db: Session, sender_id: int, receiver_id: int, content: str):
    """ Функция создания приватного сообщения"""
...
async def get_favorite_messages(db: Session, user_id: int):
    """ Просмотр избранных сообщений группы """
